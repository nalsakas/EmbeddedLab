...
/// @brief Send message packet on leyer 3.
/// @param source Source address.
/// @param destination Destination address.
/// @param packetL4 Layer 4 packet to be sent.
void rpl3_send(uint8_t source, uint8_t destination, RPL4_PACKET *packetL4)
{
    ...
    memcpy(packetL3.payload, packetL4, sizeof *packetL4);

    rpl2_send(&packetL3);
}

/// @brief Receives messages on layer 3.
